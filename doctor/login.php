...
<body>
    ...
    <div class="banner2">
        <h4>Doctor Login Page > <a href="../index.php">Home</a></h4>
    </div>
                    ...
                    <div class="card-body">
                        <form action="" id="s_form">
                            <div class="form-group mb-4">
                                <label for="" class="form-control-label">Doctor N0</label>
                                <input type="text" name="docid" id="" class="form-control">
                            </div>
                            <div class="form-group mb-4">
    ...
    <script>
        $(document).ready(function(){
            $('#s_form').submit(function(e) {
                ...
                $.jGrowl("Verifying.......")
                $.ajax({
                    url: '../process.php?p=doctor_login',
                    method: 'POST',
