    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            <div class="form-group">
                ...
                <input type="date" name="vdate" id="" class="form-control" value="<?=isset($visit_date) ? $visit_date : ""; ?>" required>
            </div>
        </div>
        <div class="col-md-6 mb-3">
            <div class="form-group">
                <label for="" class="form-control-label">Next Visit Date</label>
                <input type="date" name="nvdate" id="" class="form-control" value="<?=isset($next_visit_date) ? $next_visit_date : ""; ?>" required>
            </div>
        </div>
        <div class="col-md-6 mb-3">
            <div class="form-group">
