<?php
    $qry = $conn->query("SELECT  patients_visit.*, patients.pno, doctors.docid FROM  patients_visit INNER JOIN patients ON patients.id=patients_visit.patient_id INNER JOIN doctors ON doctors.id=patients_visit.doc_id WHERE patients_visit.doc_id='$did' ORDER BY patients_visit.id DESC");
?>
