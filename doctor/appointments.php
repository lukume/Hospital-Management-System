<?php
    $qry = $conn->query("SELECT  appointment.*, patients.pno, doctors.docid FROM  appointment INNER JOIN patients ON patients.id=appointment.patient_id INNER JOIN doctors ON doctors.id=appointment.doc_id WHERE appointment.doc_id='$did' ORDER BY appointment.id DESC");
?>
